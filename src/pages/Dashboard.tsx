            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm text-white/70">
                  Abra a lista de perfis para ver as contas locais disponíveis e decidir se quer continuar no perfil atual ou trocar de perfil, como um seletor de contas.
                </p>
              </div>
            ...
            <div className="w-full max-w-md rounded-3xl border border-white/15 bg-white/10 p-5 backdrop-blur-sm">
              ...
              <Button
                ...
                onClick={() => void openProfileSelector({
                  ...
                  description: "Veja os perfis disponíveis, escolha se quer continuar com a conta atual ou trocar para outra conta local.",
                })}
              >
